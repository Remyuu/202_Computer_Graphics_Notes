本篇文章深入探讨了两趟渲染（Two-Pass Algorithm）、Percentage Closer Filtering（PCF）阴影软化技术，以及Percentage Closer Soft Shadows (PCSS)软阴影实现算法的核心理念和运行原理。同时，我们也将讲解各种算法的优化策略及其背后的数学逻辑。未完待续。

<img src="https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo_t/image-20230731102509105.png" alt="image-20230731102509105" style="zoom: 33%;" />
...
<img src="https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo_t/image-20230803105828953.png" alt="image-20230803105828953" style="zoom: 67%;" />
...
<img src="https://regz-1258735137.cos.ap-guangzhou.myqcloud.com/remo_t/image-20230731132751055.png" alt="image-20230731132751055" style="zoom:50%;" />
...
$$
这样可以分别计算 $f_r$ 和 $L_i(n·ω_i)$ 的积分，然后将它们相乘，大大简化了计算过程。
